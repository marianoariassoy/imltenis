    ...
    <div className="navbar mb-6 ">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 bg-neutral rounded-box w-52 font-bold shadow-xl">
            <li>
      ...
      <div className="navbar-end">
        <a href="https://www.instagram.com/imltenis/" target="_blank" className="svg-primary-hover">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="#999" width="24" height="24" className="fill-current mr-3">
