...
const Reglamento = () => {
  return (
    <>
      <article className='mb-6 fade-in'>
        <div className='mb-6 text-center text-xl'>
          <h1 className='font-bold text-primary'>
            Reglamento IML Tenis <br /> Apertura 2024
          </h1>
          🤝
        </div>
        ...
        <p className='md:columns-2 gap-8 text-sm'>
          ...
          a 10 puntos con diferencia de dos.
          <br />
          <br />
          ...
          En caso de empate por puntos, se desempatará en primer lugar por mayor cantidad de series ganadas, de
          persistir el empate, por diferencia de sets y en el ultimo caso diferencia de games.
          <br />
          <br />
          <strong className='text-primary'>Formación:</strong> En la categoría Primera Libre de los 4 jugadores
          convocados para la serie, el jugador que esté más arriba en la lista de buena fe deberá jugar el single 1, el
          resto de sus compañeros el single 2 y el doble. <br /> <br />
          En el resto de las categorías de los 5 jugadores convocados para la serie, el jugador que esté más arriba en
          la lista de buena fe deberá jugar el doble 1 con cualquiera de sus compañeros, el resto de los jugadores
          pueden jugar el single y doble 2. <br />
          <br />
          <strong className='text-primary'>Formación Incompleta:</strong> Si el equipo completo o algún jugador
          visitante no se presentara a jugar la fecha correspondiente (WO) deberá avisar con un mínimo de 48hs al
          capitán rival por escrito al chat de capitanes de WhatsApp, de lo contrario deberá correr con los gastos que
          correspondan al equipo local, como ser alquiler de canchas. De tener que disputarse solo 2 encuentros, estos
          serán el single y doble 1
          <br />
          <br />
          ...
          MEDIODIA DEL JUEVES de la semana correspondiente, de lo contrario se procedera a la quita de 1 punto de la
          serie a disputarse por día de atraso, en caso de la quita de 1 punto no se jugará el doble 2.
          <br />
          <br />
          ...
          <br />
          La reprogramación se pasará para el final del torneo, salvo que los equipos involucrados se pongan de acuerdo
          y decidan jugar antes, informando previamente a esta organización.
          <br />
          <br />
          ...
          se tomarán reclamos por teléfono o WhatsApp. Tal objeción, será tomada de forma anónima.
          <br />
          <br />
          ...
          podrán jugar en ningún otro de la misma categoría a la que pertenezcan.
          <br />
          <br />
          ...
          esta asociación, a considerar, la no programación de partidos, la misma deberá ser presentada con anterioridad
          a la realización de la programación oficial e indicará fechas ciertas de los compromisos asumidos.
          <br />
          <br />
          ...
          2 canchas, cada jugador solo podrá disputar un encuentro en una misma serie. <br />
          ...
          aquellos que posean registros de haber participado y/o ganado torneos en categorías considerablemente
          superiores en el tiempo reciente, hasta 2 años, con la considerable quita de puntos correspondiente.
          <br />
          <br />
          ...
          para participar por primera vez anotarse en la categoría más baja.
          <br />
          <br />
      ...
      <Helmet>
        <title>Reglamento IML Tenis 2024</title>
      </Helmet>
    </>
  )
}
