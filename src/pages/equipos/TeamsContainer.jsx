    ...
    <>
      ...
      <section className="mb-3" id="presentacion">
          ...
          <div className="avatar mb-3">
            <div className="w-28 rounded-full bg-base-300">
              <Link to={`/clubes/${club_id}`} className="hover:opacity-70">
                <img src={image} width="128" height="128" alt={team_name} />
              </Link>
            </div>
          </div>
        ...
        <div className="row flex justify-center items-center mb-6">
          <a href={googlemaplink} target="_blank" className="btn btn-outline btn-error normal-case m-1 svg-hover-white p-2">
          ...
          <a href={`https://wa.me/${phone}`} target="_blank" className="btn btn-outline btn-error normal-case m-1 svg-hover-white p-2">
