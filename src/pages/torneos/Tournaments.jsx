...
const Tournaments = ({ group_id, name, description, winners, type }) => {
  return (
    <>
      {type == 1 ? <h2 className="font-semibold text-primary text-center mb-4 text-xl">{name}</h2> : <TournamentsGroup group_id={group_id} name={name} description={description} winners={winners} />}
